                ...
                @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6">								
                            ...
                            <select name="country_id" id="country_id" class="form-control @error('country_id') is-invalid @enderror"  value="{{ old('country_id') }}" autocomplete="country_id" autofocus>
                        ...
                        <div class="col-lg-6">								
                            ...
                            <select name="state_id" id="state_id" class="form-control @error('state_id') is-invalid @enderror"  value="{{ old('state_id') }}" autocomplete="state_id" autofocus>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="city_id" id="city_id" class="form-control @error('city_id') is-invalid @enderror" value="{{ old('city_id') }}" autocomplete="city_id" autofocus>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="mt-1 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-lg-3">
                            <label for="age">
                                Age 
                                <span class="required">*</span>
                                <span class="text-danger"><small>(Must be 18 or above)</small></span>
                            </label>
                            <input name="age" id="age" type="number" class="form-control @error('age') is-invalid @enderror" value="{{ old('age') }}" autocomplete="age" autofocus/>
                            @error('age')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea name="availability_details" id="availability_details" class="form-control"></textarea>
                        </div>							
                    </div>
                    <div class="mt-2">
                        <h4>Upload Your Images</h4>
                        <p class="text-danger"><strong>Maximum number of images (4)</strong></p>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="order-summary flex-fill">
                                    ...
                                    <div class="form-group mt-2 mb-0">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="form-check-label ml-2 ml-xs-3" for="exampleCheck1">Select This Plan</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="error-message alert alert-rounded alert-sm alert-danger" id="countryIdError" style="display: none;">
                        <i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
                        <span><strong>Please select a Country.</strong></span>
                    </div>
                    <div class="error-message alert alert-rounded alert-sm alert-danger" id="stateIdError" style="display: none;">
                        <i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
                        <span><strong>Please select a State.</strong></span>
                    </div>
                    <div class="error-message alert alert-rounded alert-sm alert-danger" id="cityIdError" style="display: none;">
                        <i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
                        <span><strong>Please select a City.</strong></span>
                    </div>
                    <div class="error-message alert alert-rounded alert-sm alert-danger" id="ageError" style="display: none;">
                        <i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
                        <span><strong>Please enter your age.</strong></span>
                    </div>
                    ...
                    <div class="error-message alert alert-rounded alert-sm alert-danger" id="posting-plan-error" style="display: none;">
                        <i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
                        <span><strong> Please select a posting plan.</strong></span>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="form-check-label ml-2 ml-xs-3" for="agree-terms">I agree to the terms and conditions of PatronCastle</label>
                        </div>                        
                    </div>                  
    ...
    <script>       
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            inputElement.addEventListener("change", function () {
                ...
                if (files.length > 4) {
                    valid = false;
                    errorMessage = "Please upload a maximum of 4 images.";
                }

                for (let i = 0; i < files.length; i++) {
                    const file = files[i];

                    if (!file.type.match(/image\/jpeg|image\/jpg|image\/heif|image\/webp|image\/png/) || file.size > 15000000) {
                    valid = false;

                    if (file.size > 15000000) {
                        errorMessage = "Please make sure each image size is less than 15MB.";
                    } else {
                        errorMessage = "Please upload JPEG, JPG, or PNG images only.";
                    }
        ...
        const countryIdError = document.getElementById("countryIdError");
        ...
        getElementById('createPostForm').addEventListener('submit', async event => {
            if (isSubmitting) {
                // If the form is already being submitted, prevent duplicate submissions
            ...
            // Disable the submit button when the form is processing for submission
            disableSubmitButton();
            ...
            const stateId = document.getElementById("state_id").value.trim();
            ...
            if (countryId === "") {
                countryIdError.style.display = "block";
            } else if (stateId === "") {
                stateIdError.style.display = "block";
            } else if (cityId === "") {
                cityIdError.style.display = "block";
            } else if (postTitle === "") {
            ...
            if (
                ...
                // If any validation failed, prevent form submission and enable the submit button
                event.preventDefault();
                enableSubmitButton();
                isSubmitting = false;
                return;
            ...
            try {
                // Simulate an asynchronous delay (replace this with your actual form submission logic)
                ...
                // Enable the submit button after the form has been successfully submitted or processed
                enableSubmitButton();
                isSubmitting = false;
            }
        });
